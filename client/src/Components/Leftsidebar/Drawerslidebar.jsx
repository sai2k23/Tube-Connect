...
import { MdOutlineExplore, MdOutlineSubscriptions, MdOutlineVideoLibrary, MdSubscriptions, MdOutlineWatchLater, MdChat } from "react-icons/md"
        ...
        <div className="container_DrawaerLeftSidebar" style={toggledrawersidebar}>
            <div className="container2_DrawaerLeftSidebar">
                <div className="Drawer_leftsidebar">
                    ...
                    <NavLink to={'/received-videos'} className="icon_sidebar_div">
                        <p>
                    ...
                    <NavLink to={"/Shorts"} className="icon_sidebar_div">
                        <p>
                        <img src={shorts} width={20} className="icon_sidebar" style={{ margin: "auto 0.7rem" }} alt="shorts" />
