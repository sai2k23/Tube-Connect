...
export const shareMultipleVideos = (videos) => API.post("/video/share/multiple", { videos });
export const getReceivedVideos = (receiverEmail) => API.get(`/video/shared`, { params: { receiverEmail } });
